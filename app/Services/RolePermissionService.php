...
final class RolePermissionService
{
    ...
    private const array REQUIRED_PARENT_PERMISSIONS = [
        ...
        PermissionEnum::ProjectCreate->value => PermissionEnum::ProjectView->value,
        PermissionEnum::ProjectUpdate->value => PermissionEnum::ProjectView->value,
        PermissionEnum::ProjectDelete->value => PermissionEnum::ProjectView->value,
